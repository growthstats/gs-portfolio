...
export default function LinkList({
  ...
  return (
    ...
    >
      ...
      <ul className="anim-fade-to-b md:frosted-glass md:bg-canvas border-ink/10 top-full left-0 px-3 py-2 max-md:border-s md:absolute md:min-w-max md:rounded-sm md:border md:shadow-md">
        {links?.map((link, key) => (
          <li key={key}>
