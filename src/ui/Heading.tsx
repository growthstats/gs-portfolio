...
const VARIANT_STYLES = {
  "display-hero":
    "text-display-hero leading-display-hero tracking-display-hero font-semibold",
  "display-xl":
    "text-display-xl leading-display-xl tracking-display-xl font-semibold",
...
export default function Heading({
  ...
  const shouldBalance =
    balance ?? ["display-hero", "display-xl"].includes(variant);
